...
.then(data => {
    ...
    u('.btnmayorprice').removeClass('text-bg-primary p-3')
    u('.btnmenorprice').removeClass('text-bg-primary p-3')
    u('.btnaz').removeClass('text-bg-primary p-3')
    u('.btnza').removeClass('text-bg-primary p-3')
    u('.btndesc').removeClass('text-bg-primary p-3') 
})
...
u('#contCategory li').handle('click',(e) =>{
    u(e.target).closest('#contCategory').find('.dropdown-item').removeClass('active')
    u(e.target).addClass('active')
    u('.listafilter').addClass('invisible')
...
u('.btndesc').handle('click', (e)=>{
    ...
    u('.btnaz').removeClass('text-bg-primary p-3')
    u('.btnza').removeClass('text-bg-primary p-3')
    u('.btndesc').addClass('text-bg-primary p-3')    
    u('div.container div.card').siblings().remove()  
...
u('.btnmenorprice').handle('click', (e)=>{
    ...
    u('.btnza').removeClass('text-bg-primary p-3')
    u('.btndesc').removeClass('text-bg-primary p-3') 
    u('.btnmenorprice').addClass('text-bg-primary p-3')
    u('div.container div.card').siblings().remove()  
...
u('.btnmayorprice').handle('click', (e)=>{
    ...
    u('.btnza').removeClass('text-bg-primary p-3')
    u('.btndesc').removeClass('text-bg-primary p-3') 
    u('.btnmayorprice').addClass('text-bg-primary p-3')
    u('div.container div.card').siblings().remove()  
...
u('.btnaz').handle('click', (e)=>{
    ...
    u('.btnza').removeClass('text-bg-primary p-3')
    u('.btndesc').removeClass('text-bg-primary p-3') 
    u('.btnaz').addClass('text-bg-primary p-3')
    u('div.container div.card').siblings().remove()  
...
u('.btnza').handle('click', (e)=>{
    ...
    u('.btnaz').removeClass('text-bg-primary p-3')
    u('.btndesc').removeClass('text-bg-primary p-3') 
    u('.btnza').addClass('text-bg-primary p-3')
    u('div.container div.card').siblings().remove()  
